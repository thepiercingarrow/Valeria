(() => {
    ...
    */
    ...
    define("leaders", ["require", "exports", "common", "ilmina_stripped"], function (require, exports, common_7, ilmina_stripped_4) {
        ...
        const hpDecrease = {
            hp: ([hp100]) => hp100 / 100,
            atk: ([_, attrBits, atk100], { ping }) => {
                return ping.source.anyAttributes(common_7.idxsFromBits(attrBits)) ? atk100 / 100 : 1;
            },
            hpMax: ([hp100]) => hp100 / 100,
                ...
                for (const c of 'rbgld') {
                    ...
                    for (const combo of comboContainer.combos[c]) {
                        ...
                        for (const ping of pings) {
                            ...
                            if (ping.isSub && ping.source.getAttribute() != common_8.Attribute.JAMMER) {
